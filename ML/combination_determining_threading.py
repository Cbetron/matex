...
if __name__ == "__main__":
    ...
    myProfile = Validation().adding_factors(valsets, Profile("Validationprofile", trainingsets, sets).get_profile())

    cores = []
    groundlist = ["comma_count", "other_adjectives", "modal_verbs", "other_adverbs", "gerunds_and_ing-form", "auxiliaries", "negation_modifiers", "flesch_index", "flesch_grade", "automated_readability", "sentence_length", "sentences_per_textlen", "typetokenrelation", "words", "spellcheck_pyenchant", "difficult_words", "foreignWord", "conjunctions", "possessive_pronouns", "conjuncts", "coordinations"]
